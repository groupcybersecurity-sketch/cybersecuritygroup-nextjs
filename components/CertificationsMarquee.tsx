...
const certifications = [
  ...
  { acronym: "CEH", name: "Certified Ethical Hacker", logo: "/certs/eccouncil.png" },
  { acronym: "ISO 27001 LA", name: "Lead Auditor ISO/IEC 27001" },
  { acronym: "eJPT v2", name: "eLearnSecurity Junior Penetration Tester" },
  { acronym: "AZ-900", name: "Microsoft Azure Fundamentals", logo: "/certs/microsoft.svg" },
];
